...
diff --git a/src/components/charts.jsx b/src/components/charts.jsx
index eb5f35a8e36c930baa920bacc4be924f8c522145..144802f8fee982773791648af52c112c7211092a 100644
...
+    });
+
+    const mTimeline = Math.max(1, ...timelineFiltrada.map((i) => i.valorEfetivo ?? 0));
+
+    return {
+      maxEmissoes: mEmissoes,
+      maxCancelamentos: mCancelamentos,
